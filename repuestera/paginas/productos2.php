...
// 🔽 Selecciona solo las imágenes que pertenecen a la categoría "productos"
$stmt = $pdo->prepare("
    SELECT i.ruta_imagen 
    FROM imagenes i
    INNER JOIN categoria c ON i.id_categoria = c.id_categoria
    WHERE c.nombre_categoria = 'productos'
...
<head>
    <meta charset="UTF-8">
    <title>Productos | Repuestera La Nueva</title>
    <style>
        body {
...
<body>
    <div class="barra">
        <marquee behavior="scroll" direction="left" scrollamount="5">
            🧰 Productos exclusivos — Repuestos, accesorios y más 🧰 
        </marquee>
    </div>
    ...
    <div class="texto-principal">
        <p>Explorá nuestra amplia gama de productos automotrices y accesorios para tu vehículo.</p> 
    </div>
    <center>
        <div class="galeria">
            <?php foreach ($imagenes as $img): ?>
                <img src="<?= htmlspecialchars($img['ruta_imagen']) ?>" alt="Imagen de productos">
            <?php endforeach; ?>
        </div>
    </center>
    <div class="texto-final">
        <p>Consultá por combos y promociones exclusivas en productos automotrices.</p> 
    </div>
    <footer>
        <center>
