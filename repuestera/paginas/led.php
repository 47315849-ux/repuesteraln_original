...
// 🔽 Selecciona solo las imágenes que pertenecen a la categoría "iluminacion"
$stmt = $pdo->prepare("
    SELECT i.ruta_imagen 
    FROM imagenes i
    INNER JOIN categoria c ON i.id_categoria = c.id_categoria
    WHERE c.nombre_categoria = 'iluminacion'
...
<head>
    <meta charset="UTF-8">
    <title>Iluminación | Repuestera La Nueva</title>
    <style>
        body {
