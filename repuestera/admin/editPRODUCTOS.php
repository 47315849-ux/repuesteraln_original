...
// ✅ Buscar el id_categoria correspondiente a 'productos'
$stmtCat = $pdo->prepare("SELECT id_categoria FROM categoria WHERE nombre_categoria = 'productos'");
$stmtCat->execute();
$id_categoria = $stmtCat->fetchColumn();

if (!$id_categoria) {
    die("❌ No existe la categoría 'productos' en la tabla categoria.");
}
...
// --- Obtener todas las imágenes de la categoría 'productos' ---
...
<h1>🛒 Panel de Edición - Productos</h1>
...
<a href="/paginas/productos2.php" class="volver">← Volver a Productos</a>
